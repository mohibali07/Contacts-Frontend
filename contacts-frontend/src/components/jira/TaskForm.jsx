...
const TaskForm = () => {
  ...
  const saveTask = (redirectMode) => {
    ...
    if (redirectMode === 'list') {
      ...
      if (isEdit) {
        navigate('/jira/tasks/add');
      }
    } else if (redirectMode === 'continue') {
      if (!isEdit && newId) {
        navigate(`/jira/tasks/edit/${newId}`, { replace: true });
      }
    }
  };
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
          <div className="p-8 space-y-8">
              ...
              <div className="md:col-span-10 flex items-center gap-3">
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    className="pl-10 pr-4 py-2.5 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition-all font-medium"
                  />
                ...
                <span className="text-sm text-slate-500">
                  ...
                  <span className="ml-1 cursor-pointer hover:text-slate-700">📅</span>
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
              ...
              <div className="md:col-span-10 text-sm text-slate-600 font-medium">
